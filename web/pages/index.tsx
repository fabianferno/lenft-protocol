...
const footerNavigation = {
  ...
  social: [
    {
      name: "Twitter",
      href: "https://www.twitter.com/lenft",
      icon: (props: any) => (
    ...
    {
      name: "GitHub",
      href: "https://www.github.com/lenft",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Landing() {
  return (
    <>
      <Head>
        <title>lenft</title>
        <meta name="title" content="lenft" />
        <meta name="description" content="lenft" />

        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://lenft.vercel.app/meta-image.jpg"
        />
        <meta property="og:title" content="lenft" />
        <meta property="og:description" content="lenft" />
        <meta
          property="og:image"
          content="https://lenft.vercel.app/meta-image.jpg"
        />
        ...
        <meta property="twitter:url" content="https://lenft.vercel.app/" />
        <meta property="twitter:title" content="lenft" />
        <meta property="twitter:description" content="lenft" />
        <meta
          ...
          <div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
                Create and deliver. <br /> Start using lenft today.
              </h2>
          ...
          <div className="mx-auto max-w-7xl px-6 pb-8 pt-4 lg:px-8">
            <div className="border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
              ...
              <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
                &copy; 2023 lenft. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
