...
const lenft_CONTRACT_ADDRESS = "0x0AE7d655Cda406c5b73Ea76855e2cE6aC3812a8E";

const GRAPHQL_ENDPOINT =
  "https://api.studio.thegraph.com/query/51108/lenft-testing/v2.0.0";
...
const VAULT_CONTRACT_ABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_lenft", type: "address" },
    ...
    inputs: [
      {
        ...
        internalType: "struct lenftV2.CreateDropInputParams",
        name: "inputParams",
        type: "tuple",
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: "struct lenftV2.CreateEditionInputParams",
        name: "inputParams",
        type: "tuple",
      },
    ],
